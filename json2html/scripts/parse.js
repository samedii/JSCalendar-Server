...
function hideChild(ele)
{
   ...
   for(i = 0; i < nodes.length; i++)
   {
      if(nodes[i].tagName == "TABLE")
      {
         ...
         ele.src = (minimizing ? "/JSCalendar-Server/json2html/images/max.gif" : "/JSCalendar-Server/json2html/images/min.gif");
